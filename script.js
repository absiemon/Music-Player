...
const currentSongName = document.getElementById('songInfoMainTitle').innerHTML;
let index = songs.findIndex((item) =>  item.songName === currentSongName);
...
document.getElementById('next').addEventListener('click', ()=>{
    ...
    document.getElementById('songInfoCover').setAttribute("src", `${songs[index].coverPath}`);
    document.getElementById('songInfoMainTitle').innerHTML = songs[index].songName;
    document.getElementById('songInfoMainSinger').innerHTML= songs[index].singer;
...
document.getElementById('previous').addEventListener('click', ()=>{
    ...
    document.getElementById('songInfoCover').setAttribute("src", `${songs[index-1].coverPath}`);
    document.getElementById('songInfoMainTitle').innerHTML = songs[index-1].songName;
    document.getElementById('songInfoMainSinger').innerHTML= songs[index-1].singer;
...
// Scrolling horizontally on clicking on the button.

const rightScroll = document.getElementById('scrollRight');
var input = document.getElementById('favSongs');
let scrollAmount = 0;
